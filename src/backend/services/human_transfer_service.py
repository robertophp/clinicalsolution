    ...
    *,
    ...
    if use_en:
        instructions = (
            ...
            "- Urgent/emergency/same-day request or dental pain: assistant uses consultar_primer_dia_disponible, "
            "explains no same-day slots, offers primeras_tres_horas from tomorrow with evaluacion — do NOT escalate.\n"
            "- Maxillofacial / maxilo INFO or price questions (catalog has evaluacion_con_especialista_maxilofacial): "
            "requires_human_transfer=false — answer from catalog; do NOT escalate.\n"
            "- Maxillofacial appointment or availability requests are handled by a dedicated direct-transfer flow — "
            "do NOT use especialidades topic for maxilo.\n"
            "POLICY — requires_human_transfer=true (immediate, no booking):\n"
            "- Explicit request to speak with a doctor, manager, or human (contacto_humano): escalate; do NOT schedule.\n"
        ...
        instructions = (
            ...
            "- Urgente, emergencia, cita hoy o dolor: el asistente usa consultar_primer_dia_disponible, explica que no hay "
            "citas el mismo día, ofrece primeras_tres_horas desde mañana con evaluacion — NO derivar.\n"
            "- Preguntas informativas o de precio sobre maxilofacial/maxilo (catálogo incluye evaluacion maxilofacial): "
            "requires_human_transfer=false — responder con catálogo; NO derivar.\n"
            "- Pedidos de cita u horarios maxilofaciales los maneja un flujo dedicado de derivación directa — "
            "NO uses el tema especialidades para maxilo.\n"
            "POLÍTICA — requires_human_transfer=true (inmediato, sin agendar):\n"
            "- Petición explícita de hablar con doctor/a, encargado/a o humano (contacto_humano): derivar; NO agendar citas.\n"
